...
// Each flow `ui_url` and the default browser return URL is an optional string;
// `allowed_return_urls` is an array of strings (add/remove rows). The keys ARE
// the allowlisted JSON-Pointers — there is NO logout ui_url key (Pitfall 1).
